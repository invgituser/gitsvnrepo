...
public class LTAMSaveSP extends StoredProcedure
{
   ...
   public Map saveLTAMUserData(LTAMCustomerData data)
   {
      ...
      inputMap.put("p_advisor",data.getAdvisor());
      inputMap.put("p_rep",data.getRep());
      inputMap.put("p_email",data.getIpaddress());
      inputMap.put("p_firstName",data.getSource());
      inputMap.put("p_lastName",data.getInvestment());
      ...
      inputMap.put("p_risk1",data.getRiskValue(data.getAns1()));
      inputMap.put("p_ans2",data.getAns2());
      inputMap.put("p_risk2",data.getRiskValue(data.getAns2()));
      inputMap.put("p_ans3",data.getAns3());
      inputMap.put("p_risk3",data.getRiskValue(data.getAns3()));
      inputMap.put("p_ans4",data.getAns4());
      inputMap.put("p_risk4",data.getRiskValue(data.getAns4()));
      inputMap.put("p_ans5",data.getAns5());
      inputMap.put("p_risk5",data.getRiskValue(data.getAns5()));
      inputMap.put("p_ans6",data.getAns6());
      inputMap.put("p_risk6",data.getRiskValue(data.getAns6()));
