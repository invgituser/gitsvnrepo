         	  ...
         	  $('#oerationDetails').html("");
         	   var obj = JSON.parse(response);
  	       	...
  	       	$.each(obj.siteDetails, function( index, value ) {
  				DYN_HTML_TBODY+="</br><a href='#' onclick='getItemSummariesForSite("+value.siteAccId+","+invUserId+")'>"+value.siteName+"</a> ("+value.siteAccId+","+value.siteId+")  <a href='#' onclick='getTokan(\"EDIT_ACC\",\""+value.siteAccId+"\")'>Edit</a>   <a href='#' onclick='getTokan(\"REFRESH_ACC\",\""+value.siteAccId+"\")'>Refresh</a>";
         	 ...
         	 data: { siteAccId: siteAccountId,invUserId:invUserId} ,
         	  ...
         	  $('#getItemSummariesForSiteRes').html("");
         	   var obj = JSON.parse(response);
  	       	...
  	       	DYN_HTML_TBODY+="<td>";
  	       		//alert(value.contentServiceInfo.containerInfo.containerName);
  	       		if(value.contentServiceInfo.containerInfo.containerName=='bank'){
	  	       		DYN_HTML_TBODY+="<B><U>Bank Details</U></B>"+
	  	       						"</br><B>" +value.itemDisplayName+"</B>";
		  	       	$.each(value.itemData.accounts, function( index, value ) {
		  				DYN_HTML_TBODY+="</br>Account Holder:- " +value.accountHolder+
		  				"</br> Account Type:- " +value.acctType+
		  				"</br> Account Number:- " +value.accountNumber+
		  				"</br> Available Balance:- " +value.availableBalance.amount+
		  				"</br> Maturity Date:- " +value.maturityDate+
		  				"</br> Current Balance:- " +value.currentBalance.amount+"</br>";
		  			});
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='credits'){
		  	       	...
		  	       	$.each(value.itemData.accounts, function( index, value ) {		  	       	
		  				...
		  				"</br>Amount Due or Ending Balance:- " +value.amountDue.amount+
		  				"</br>Total Credit Line:- " +value.totalCreditLine.amount;
	  			});
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='minutes'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='orders'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='telephone'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='stocks'){  	 
  	       				DYN_HTML_TBODY+="<B><U>Investment Details</U></B>"+
  	       								"</br><B>" +value.itemDisplayName+"</B>";
					 	$.each(value.itemData.accounts, function( index, value ) {		  	       	
						DYN_HTML_TBODY+="</br>Account Type:- "+value.acctType+
						"</br>Account Number:- " +value.accountNumber+
						"</br>Account Name:- " +value.accountName+
						"</br>Plan Name:- " +value.planName+
						"</br>As Of:- " +value.asofDate.date+
						"</br>Cash:- " +value.cash.amount+
						"</br>Margin Balance:- " +value.marginBalance.amount+
						"</br>Total Balance:- " +value.totalBalance.amount+
						"</br>Total Vested Balance:- " +value.totalVestedBalance.amount+
						"</br>Account Holder:- " +value.accountHolder+
						"</br>Account Status:- " +value.itemAccountStatusId;
						/* +
						"</br>Investment Holding(s):- " +value.amountDue.amount+
						"</br>Investment Transaction(s):- " +value.totalCreditLine.amount; */
				});
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='miles'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='bills'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='loans'){  	   
  	       		...
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='mortgage'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='bill_payment'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='insurance'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='utilities'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='cable_satellite'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='isp'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='prepay'){  	       			
  	       		}else if(value.contentServiceInfo.containerInfo.containerName=='RealEstate'){  	       			
  	       		}
    ...
    -->     <div align="center">
        	...
        	<table>
	        	...
	        	<tr>
					...
					<td>${user.userId}</td>
					<td>${user.email}</td>
					<td><a href="#" onclick="login('${user.invUserId}')">Registration</a></td>
